      ...
      <div className="mb-4 grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4">
        {Object.keys(TemplateMappings).map((id) => {
          ...
          return (
            <div
              key={id}
              className={`flex cursor-pointer flex-col items-center rounded-md border bg-gray-900 p-6 ${
          ...
          <DialogContent className="flex min-h-[90vh] min-w-[90vw] flex-col" showCloseButton={false}>
            <DialogHeader className="flex flex-row items-center justify-between">
              ...
              <DialogDescription className="sr-only">
                Preview of template {previewTemplate}. Contains an iframe showing the template example.
              </DialogDescription>
